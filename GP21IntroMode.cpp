...
GP21IntroMode::GP21IntroMode(std::function< void() > next_mode_) : goto_nextmode(next_mode_) {
// GP21IntroMode::GP21IntroMode(std::function< void() > on_finish_) : init_gamemode(on_finish_) {
